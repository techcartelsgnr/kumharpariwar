...
/**
 * Helper: Remove HTML tags from notification body
 */
...
/**
 * ✅ Fetch FCM Token
 * Generates and logs the device FCM token.
 ...
 * Handles foreground, background, and killed-state notifications.
 */
export const notificationListener = () => {
